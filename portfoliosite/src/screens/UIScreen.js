...
const UIScreen = () => {
    ...
    return (
        ...
        <div className="tf-contentblockimage"><img src={ImgPubsWide} /><p>The new publications listing features React-powered controls: sorting, revealing, sharing.</p></div>
        <div className="tf-contentblockimage"><img src={ImgPubsSmall} /><p>The responsive small screen view, with revealed publication details.</p></div>
        </div>
        </div>  
        <div className="tf-contentblock">
         ...
         <div className="tf-contentblockimages">
        <div className="tf-contentblockimage"><img src={ImgAccordion} /><p>The new accordion widget uses a configured heading level in its toggle controls, and is keyboard-navigable.</p></div>
        </div>
        </div> 
        <div className="tf-contentblock">
         ...
         <div className="tf-contentblockimages">
        <div className="tf-contentblockimage"><img src={ImgToggle} /><p>Mobile platforms made the toggle control ubiquitous for settings.</p></div>
        </div>
        </div>    
        </div>
        </div>
