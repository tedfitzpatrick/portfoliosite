...
const VisualsScreen = () => {
    ...
    return (
        ...
        <div className="tf-contentblockimage"><img src={ImgMemoriamWide} /><p>I used the IntersectionObserver API with animated CSS filters so that when an officer's portrait comes into view, it transitions from sepia-tone (tinted grayscale) to color, as if a memory returning.</p></div>
        <div className="tf-contentblockimage"><img src={ImgMemoriamSmall} /><p>The responsive small screen view.</p></div>
        <div className="tf-contentblockimage"><img src={ImgHonorDisplay} /><p>The digital signage is driven by the same JSON file as the webpage.</p></div>
        </div>
        </div>  
        <div className="tf-contentblock">
         ...
         <div className="tf-contentblockimages">
        <div className="tf-contentblockimage"><img src={ImgPMRWide} /><p>I used a background linear gradient and the "background clip" property to add subtle styling to the masthead branding.</p></div>
        <div className="tf-contentblockimage"><img src={ImgPMRSmall} /><p>The responsive small screen view.</p></div>
        </div>
        </div> 
        <div className="tf-contentblock">
         ...
         <div className="tf-contentblockimages">
        <div className="tf-contentblockimage"><img src={ImgOrgWide} /><p>I used CSS Flexbox extensively to make the chart web-native.</p></div>
        <div className="tf-contentblockimage"><img src={ImgOrgSmall} /><p>The responsive small screen view.</p></div>
        </div>
        </div>    
        </div>
        </div>
